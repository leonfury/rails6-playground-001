...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { cover: @library.cover, description: @library.description, title: @library.title } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { cover: @library.cover, description: @library.description, title: @library.title } }
